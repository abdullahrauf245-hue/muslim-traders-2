    ...
    <div className="timeline-page">
      ...
      <header className="timeline-header">
        ...
        <p className="timeline-subtitle">
          From humble beginnings in 1988 to becoming an exclusive PTC
          distributor — every partnership tells a story of trust, growth, and
          market excellence.
        </p>
      </header>
      ...
      <section className="velo-showcase">
        <div className="velo-header">
          ...
          <p className="velo-subtitle">
            All 17 SKUs with unit rates (PKR) — the full portfolio.
          </p>
        </div>
